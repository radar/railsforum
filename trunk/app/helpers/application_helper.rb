...
module ApplicationHelper
  def bbcode(text)
    ...
    text.gsub!(/\[quote=?["']?(.*?)["']?\](.*?)\[\/quote\]/mis) { "<div align='center'><div class='quote'><b>" << $1 << " wrote:</b><br>" << $2 << "</div></div>" }
    text.gsub!(/\[quote\](.*?)\[\/quote\]/mis) { "<div align='center'><div class='quote'>" << $1 << "</div></div>" }
